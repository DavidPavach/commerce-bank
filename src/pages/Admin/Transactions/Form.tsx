            ...
            <Card className="shadow-sm mx-auto mt-10 border-neutral-200 max-w-4xl">
                ...
                <CardContent className="flex flex-col gap-y-4">
                    ...
                    <div className="flex flex-col gap-y-1">
                        ...
                        <Input type="text" id="accountNumber" className="bg-inherit px-4 py-2 border border-neutral-200 rounded-lg focus:outline-1 focus:outline-none focus:outline-primary w-full text-black duration-300 focus:caret-primary" value={formData.details.bankName} onChange={(e) => handleChange("bankName", e.target.value)} inputMode="numeric" max={12} placeholder="Enter Account Number" pattern="\d{10,12}$" title="Account number must be 10 to 12 digits long" />
                    </div>
